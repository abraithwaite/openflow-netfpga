...
force -freeze sim:/$module/reset 1'h1 0 -cancel 50

for {set i 0} {$i < $cycles} {incr i} {
    set val [expr $i * 100 + 30000]
    ...
    force -freeze sim:/$module/reg_rd_wr_L_in 1'h$reg_rd_wr $start -cancel $stop
    force -freeze sim:/$module/reg_req_in 1'h$reg_req $start -cancel $stop
}
